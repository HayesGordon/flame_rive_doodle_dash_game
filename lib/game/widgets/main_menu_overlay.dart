                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      CharacterButton(
                        character: Character.robodude,
                        selected: character == Character.robodude,
                        onSelectChar: () {
                          setState(() {
                            character = Character.robodude;
                          });
  ...
  Widget build(BuildContext context) {
    return OutlinedButton(
      ...
      child: Padding(
        ...
        child: Column(
          children: (character == Character.robodude)
              ? [
                  SizedBox(
                    ...
                    child: Transform.scale(
                      scale:
                          1.3, // Transform is only to get the animation looking great next to the other Assets. You could also alter the Artboard in the Rive Editor.
                      child: const RiveAnimation.asset(
                        'assets/rive/robodude_flutter.riv',
